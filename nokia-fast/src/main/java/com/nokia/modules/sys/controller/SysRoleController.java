...
public class SysRoleController extends BaseController {
	...
	public RData info(@PathVariable("roleId") Long roleId){
	...
	public RData save(@RequestBody SysRoleEntity role){
//		ValidatorUtils.validateEntity(role);
	...
	public RData update(@RequestBody SysRoleEntity role){
//		ValidatorUtils.validateEntity(role);
	...
	public RData delete(@RequestBody Long[] roleIds){
