    ...
    <div id="container">
        <el-row>
            <el-col :span="6" :offset="1">
                <el-progress :percentage="onePercentage" color="#f56c6c" :format="oneFormat"
                             :stroke-width="3"></el-progress>
            </el-col>
            <el-col :span="6" :offset="1">
                <el-progress :percentage="twoPercentage" color="#e6a23c" :format="twoFormat"
                             :stroke-width="3"></el-progress>
            </el-col>
            <el-col :span="6" :offset="1">
                <el-progress :percentage="ThreePercentage" color="#67c23a" :format="ThreeFormat"
                             :stroke-width="3"></el-progress>
            </el-col>
