<template>
    <div id="qhXuqiuByOperator_pie" class="chart-box"></div>
</template>
    ...
    export default {
        ...
        methods: {
            initChartPie() {
                ...
                this.chartPie = echarts.init(document.getElementById('qhXuqiuByOperator_pie'), 'macarons');
