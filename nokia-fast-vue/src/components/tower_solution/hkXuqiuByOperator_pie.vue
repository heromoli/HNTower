<template>
    <div id="hkXuqiuByOperator_pie" class="chart-box"></div>
</template>
    ...
    export default {
        ...
        methods: {
            initChartPie() {
                ...
                this.chartPie = echarts.init(document.getElementById('hkXuqiuByOperator_pie'), 'macarons');
