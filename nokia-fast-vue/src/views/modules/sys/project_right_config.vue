<template>
    <div class="mod-log">
        ...
        <add-or-update v-if="addOrUpdateVisible" ref="projectRightConfigInfo"
                       @refreshDataList="getDataList"></add-or-update>
    </div>
</template>

<script>
    import AddOrUpdate from './project_right_config_info'
    ...
    export default {
        ...
        methods: {
            ...
            getDataList() {
                ...
                this.$http({
                    url: this.$http.adornUrl('/sys/project/config/list'),
                    method: 'get',
            ...
            addRightConfig() {
                this.addOrUpdateVisible = true;
                this.$nextTick(() => {
                    this.$refs.projectRightConfigInfo.init({})
                })
            }
        }
    }
